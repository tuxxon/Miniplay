...
extension YTFViewController {
    ...
    func minimizeViews() {
        ...
        print("playButton.frame = \(self.play.frame)")
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, options: .curveEaseOut, animations: {
            self.playerView.frame = self.playerViewMinimizedFrame!
            self.view.frame = self.viewMinimizedFrame!
            self.view.backgroundColor = UIColor.black   //added by Gordon Ahn.
            ...
            self.miniPlay.frame.origin.x = 200
            self.miniClose.frame.origin.x = 280

//            self.play.frame.origin.y = trueOffset + 2
//            self.play.frame.origin.x = xOffset + 50
